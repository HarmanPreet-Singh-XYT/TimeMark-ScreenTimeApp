...
class AppAutoLauncherImplWindows extends AppAutoLauncher {
  AppAutoLauncherImplWindows({
    ...
    // Add the auto-start flag to the arguments list
    final launchArgs = [...args, '--auto-launched'];
    _registryValue = launchArgs.isEmpty ? appPath : '$appPath ${launchArgs.join(' ')}';
  }
...
class AppAutoLauncherImplWindowsMsix extends AppAutoLauncher {
  ...
  final String script = '''
    ...
    \$Shortcut.Arguments = "${args.join(' ')} --auto-launched" 
    \$Shortcut.Save()
  ''';
